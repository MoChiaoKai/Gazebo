...
def generate_launch_description():
    ...
    declare_world_cmd = DeclareLaunchArgument(
        ...
        description='World file name (e.g., temp.world, cafe.world, house.world)')
    ...
    # Feature flags
    declare_enable_rgbd_cmd = DeclareLaunchArgument(
        name='enable_rgbd',
        default_value='false',
        choices=['true', 'false'],
        description='Enable RGBD camera during Gazebo bringup')
    ...
    # Feature flags
    ld.add_action(declare_enable_rgbd_cmd)
