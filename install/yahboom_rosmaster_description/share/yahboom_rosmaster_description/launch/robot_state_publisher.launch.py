...
def process_ros2_controllers_config(context):
    ...
    # Use package-share-relative paths so this works in any workspace location.
    pkg_share = FindPackageShare(
        package='yahboom_rosmaster_description').find('yahboom_rosmaster_description')
    ...
    # Write processed content next to the template used by this launch.
...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('use_namespace', default_value='false',
                          choices=['true', 'false'],
                          description='Whether to namespace ros2_control and robot_description for multi-robot use'),
    DeclareLaunchArgument('use_gazebo', default_value='false',
                          choices=['true', 'false'],
                          description='Whether to use Gazebo simulation'),
    DeclareLaunchArgument('enable_rgbd', default_value='true',
                          choices=['true', 'false'],
                          description='Enable RGBD camera in URDF model'),
